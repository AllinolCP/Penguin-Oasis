class com.clubpenguin.net.Airtower
{
    ...
    {
        var _loc3 = this.getListenersArray(type);
        var _loc2 = this.getListenerIndex(_loc3, func);
        if (_loc2 != -1)
        {
    ...
    function handleOnLogin(obj)
    {
        ...
        playerId = obj[1];
        shell.updateWorldsInfo(obj[5]);
        shell.updateWorldPopulations(obj[4]);
        shell.setWorldsWithBuddies(obj[3]);
        shell.myColour = shell.getPlayerHexFromId(obj[6]);
        shell.myUser = obj[8];
        login_key = obj[2];
        login_data = obj[9];
        login_data_confirmation = obj[10];
    ...
    function worldLogin()
    {
        server.worldLogin(com.clubpenguin.net.Airtower.SERVER_ZONE, username, login_key, login_data, login_data_confirmation);
    } // End of the function
    function joinWorld()
    {
    ...
    function handleJoinWorld(obj)
    {
        ...
        var _loc6 = Boolean(Number(obj[2]));
        var _loc4 = Boolean(Number(obj[3]));
        var _loc5 = Boolean(Number(obj[4]));
        this.on_world_response(true, _loc3, _loc6, _loc4, _loc5);
        on_world_response = undefined;
    } // End of the function
