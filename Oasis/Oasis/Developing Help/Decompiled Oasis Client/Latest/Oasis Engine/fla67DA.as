...
function addPlayer(player_ob, targetX, targetY)
{
    ...
    var _loc23 = getRoomBlockMovieClip();
    var _loc6 = player_ob.player_id;
    var _loc12 = player_ob.nickname;
    removePlayer(_loc6);
    var _loc13 = addPlayerDepth(_loc6);
    var _loc11 = "p" + String(_loc6);
    ...
    if (!SHELL.isLag)
    {
        ...
        var _loc17 = String("0x") + String(_loc3.player_attributes.n[0]);
        if (_loc3.player_attributes.n[0] != "0" && _loc3.player_attributes.n[0] != "" && _loc3.player_attributes.n[0] != undefined)
        {
            _loc9.filters = [new flash.filters.GlowFilter(_loc17, 10, 1.700000, 1.700000, 15, 3, false, false)];
        } // end if
    } // end if
    var _loc10 = null;
    ...
    else if (SHELL.isPlayerMascotById(_loc6) && _loc5.customMascotSize != undefined)
    {
    ...
    _loc3.onRelease = com.clubpenguin.util.Delegate.create(this, clickPlayer, _loc6, _loc12);
    if (SHELL.isMyPlayer(_loc6))
    {
        var _loc18 = SHELL.getLocalizedString("load_penguin");
        SHELL.showLoading(_loc18, listener);
    } // end if
    ...
    var _loc15 = com.clubpenguin.util.URLUtils.getCacheResetURL(_loc14);
    _loc10 = new com.clubpenguin.hybrid.HybridMovieClipLoader();
    _loc10.addEventListener(com.clubpenguin.hybrid.HybridMovieClipLoader.EVENT_ON_LOAD_INIT, com.clubpenguin.util.Delegate.create(this, onPlayerLoadInit, player_ob, _loc6, targetX, targetY));
    ...
    _loc10.loadClip(_loc15, _loc3.art_mc);
    _loc3.art_mc.ring._visible = false;
    if (!SHELL.isLag)
    {
        if (_loc3.player_attributes.r != undefined && _loc3.player_attributes.r != "")
        {
            _loc3.art_mc.ring._visible = true;
            var _loc16 = new Color(_loc3.art_mc.ring);
            _loc16.setRGB("0x" + _loc3.player_attributes.r);
        }
        else
        {
            _loc3.art_mc.ring._visible = false;
