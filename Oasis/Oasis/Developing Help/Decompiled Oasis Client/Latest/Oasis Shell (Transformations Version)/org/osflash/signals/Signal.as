class org.osflash.signals.Signal implements org.osflash.signals.IDispatcher, org.osflash.signals.ISignal
{
    ...
    function dispatch()
    {
        ...
        for (var _loc3 = 0; _loc3 < _valueClasses.length; ++_loc3)
        {
            ...
            _loc5 = arguments[_loc3];
            if (_loc5 == null || _loc5 instanceof _valueClasses[_loc3])
            {
                continue;
            } // end if
            throw new Error("Value object <" + _loc5 + "> is not an instance of <" + _valueClasses[_loc3] + ">.");
        } // end of for
        ...
        for (var _loc6 = 0; _loc6 < _loc8; ++_loc6)
        {
            _loc4 = _loc7[_loc6];
            if (_loc4.once)
            {
