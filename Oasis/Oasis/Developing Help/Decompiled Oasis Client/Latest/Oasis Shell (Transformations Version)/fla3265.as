...
{
    var _loc4 = player_string.split("|");
    var _loc5 = Number(_loc4[0]);
    var _loc7 = String(_loc4[1]);
    var _loc9 = Number(_loc4[2]);
    var _loc8;
    ...
    _loc1.colour_id = String(_loc4[3]) || 0;
    _loc1.head = Number(_loc4[4]) || 0;
    _loc1.face = Number(_loc4[5]) || 0;
    _loc1.neck = Number(_loc4[6]) || 0;
    _loc1.body = Number(_loc4[7]) || 0;
    _loc1.hand = Number(_loc4[8]) || 0;
    _loc1.feet = Number(_loc4[9]) || 0;
    _loc1.flag_id = Number(_loc4[10]) || 0;
    _loc1.photo_id = Number(_loc4[11]) || 0;
    var _loc3 = ["head", "face", "neck", "body", "hand", "feet"];
    for (var _loc6 in _loc3)
    {
        var _loc2 = Number(_loc1[_loc3[_loc6]]);
        if (_loc2 == 0)
        {
            continue;
        } // end if
    ...
    _loc1.x = Number(_loc4[12]) || 0;
    _loc1.y = Number(_loc4[13]) || 0;
    _loc1.frame = Number(_loc4[14]) || 0;
    _loc1.is_member = Boolean(Number(_loc4[15]) || 0);
    _loc1.total_membership_days = Number(_loc4[16]) || 0;
    if (!isSnowball)
    {
        _loc1.playercard_attributes = parseJson(_loc4[19]);
        _loc1.account_permissions = _loc4[20];
        _loc1.char_permissions = _loc4[21];
        _loc1.player_attributes = parseJson(_loc4[22]);
        _loc1.ia = Boolean(Number(_loc4[23]));
        _loc1.credits = Number(_loc4[24]);
        _loc1.characterId = String(_loc4[25]);
    }
    else
    {
        _loc1.size_decrease = Number(_loc4[19]);
        _loc1.alpha = Number(_loc4[20]);
    } // end else if
