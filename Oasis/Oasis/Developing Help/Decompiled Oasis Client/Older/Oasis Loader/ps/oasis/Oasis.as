class ps.oasis.Oasis
{
    function Oasis()
    {
       ...
       // System.security.allowDomain("*.oasis.private");
        ...
        _loc4.load($httpType + "://localhost/Oasis/Web/service-authx1/configuration/latest");
    } // End of the function
    function LoadLatestTuning()
    {
        ...
        _loc3.load($httpType + "://localhost/Oasis/Web/service-authx1/configuration/tuning/" + _global._configuration.latest_tuning);
    } // End of the function
