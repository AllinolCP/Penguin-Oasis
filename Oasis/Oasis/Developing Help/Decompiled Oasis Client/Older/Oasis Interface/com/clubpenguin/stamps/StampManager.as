class com.clubpenguin.stamps.StampManager
{
    ...
    function getStampBookItem(id, typeValue)
    {
        ...
        {
            var _loc3 = this.findStampBookItemInItemsList(id, _usersStampCategories[_loc4].getItems(), typeValue);
            if (_loc3 != undefined)
            {
                return (_loc3);
                continue;
            } // end if
            var _loc5 = _usersStampCategories[_loc4].getSubCategories();
            if (_loc5 != undefined)
            {
                var _loc6 = _loc5.length;
                for (var _loc2 = 0; _loc2 < _loc6; ++_loc2)
                {
                    _loc3 = this.findStampBookItemInItemsList(id, _loc5[_loc2].getItems(), typeValue);
                    if (_loc3 != undefined)
                    {
                        return (_loc3);
                    } // end if
    ...
    function saveMyStampBookCover(stampBookCover)
    {
        ...
        var _loc14 = stampBookCover.getHighlightID();
        var _loc16 = stampBookCover.getPatternID();
        var _loc15 = stampBookCover.getClaspIconArtID();
        var _loc10 = [];
        var _loc11 = stampBookCover.getCoverItems();
        var _loc12 = _loc11.length;
        for (var _loc3 = 0; _loc3 < _loc12; ++_loc3)
        {
            var _loc2 = _loc11[_loc3];
            var _loc6 = _loc2.getItem();
            var _loc5 = _loc6.getType().__get__value();
            var _loc4 = _loc6.getID();
            var _loc7 = _loc2.getItemPosition();
            var _loc8 = _loc2.getItemRotation();
            var _loc9 = _loc2.getItemDepth();
            if (_loc5 == com.clubpenguin.stamps.StampBookItemType.AWARD.__get__value())
            {
                _loc4 = com.clubpenguin.stamps.StampManager.AWARD_STAMP_IDS_TO_DB_IDS[_loc4];
            } // end if
            _loc10.push(_loc5 + com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER + _loc4 + com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER + _loc7.x + com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER + _loc7.y + com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER + _loc8 + com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER + _loc9);
        } // end of for
        stampsService.setStampBookCoverDetails(_loc17, _loc14, _loc16, _loc15, _loc10);
    } // End of the function
    ...
    function handleQueryPlayersPins(serverEventData)
    {
        ...
        var _loc10 = [];
        var _loc11 = serverEventData.length;
        for (var _loc4 = 0; _loc4 < _loc11; ++_loc4)
        {
            var _loc5 = serverEventData[_loc4].split(com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER);
            var _loc6 = Number(_loc5[0]);
            var _loc7 = shell.getInventoryObjectById(_loc6);
            if (_loc7 != undefined)
            {
                var _loc8 = _loc7.name;
                var _loc3 = new Date(Number(_loc5[1]) * com.clubpenguin.stamps.StampManager.MILLISECONDS);
                var _loc2 = shell.getLocalizedString("pin_release_date");
                var _loc9 = Number(_loc5[2]) == 1 ? (true) : (false);
                ...
                _loc10.push(new com.clubpenguin.stamps.PinItem(_loc6, _loc8, _loc2, _loc9));
            } // end if
        } // end of for
        var _loc14 = new com.clubpenguin.stamps.StampBookCategory(com.clubpenguin.stamps.StampManager.PIN_CATEGORY_ID, pinCategoryName, [], _loc10, []);
        _usersStampCategories = clubPenguinStampCategories.concat(_loc14);
        var _loc13 = new com.clubpenguin.stamps.StampBookCategory(com.clubpenguin.stamps.StampManager.MYSTERY_CATEGORY_ID, com.clubpenguin.stamps.StampManager.MYSTERY_PAGE_TITLE, [], [], []);
        _usersStampCategories.push(_loc13);
    ...
    function handleQueryPlayersAwards(serverEventData)
    {
        ...
        for (var _loc2 = 0; _loc2 < _loc4; ++_loc2)
        {
            serverEventData[0] = serverEventData[0] + this.getAwardStampID(_loc5[_loc2]);
            if (_loc2 < _loc4 - 1)
            {
    ...
    function handleGetStampBookCoverDetails(serverEventData)
    {
        ...
        {
            var _loc2 = serverEventData[_loc3].split(com.clubpenguin.stamps.StampManager.SOCKET_SERVER_DATA_DELIMITER);
            var _loc4;
            if (_loc2[0] == com.clubpenguin.stamps.StampBookItemType.AWARD.__get__value())
            {
                _loc2[1] = this.getAwardStampID(_loc2[1]);
            } // end if
            _loc4 = this.getStampBookItem(_loc2[1], _loc2[0]);
            if (_loc4 != undefined)
            {
                var _loc5 = new com.clubpenguin.stamps.StampBookCoverItem(_loc4, new flash.geom.Point(_loc2[2], _loc2[3]), _loc2[4], _loc2[5]);
                _loc7.push(_loc5);
            } // end if
        } // end of for
        _loc10 = new com.clubpenguin.stamps.StampBookCover(_loc7, _loc12, _loc13, _loc11, _loc9);
    ...
    function createStampBookItemListFromServerData(serverEventData, typeValue)
    {
        ...
        for (var _loc2 = 0; _loc2 < _loc6; ++_loc2)
        {
            var _loc3 = this.getStampBookItem(_loc4[_loc2], typeValue);
            if (_loc3 != undefined)
            {
                _loc5.push(_loc3);
            } // end if
