class com.clubpenguin.util.LogChannel
{
    ...
    function LogChannel(name)
    {
        ...
        _numMasks = _numMasks = ++com.clubpenguin.util.LogChannel._numMasks;
        com.clubpenguin.util.Log.ALL._bitMask = com.clubpenguin.util.Log.ALL._bitMask + this.__get__bitMask();
    } // End of the function
    function get name()
    {
        return (_name);
