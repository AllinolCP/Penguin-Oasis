class com.clubpenguin.world.rooms.weathereffects.effect.FireEffectGenerator
{
    ...
    function setupElement(index)
    {
        ...
        _loc2.gotoAndStop(1);
        _loc2.index = index;
        var _loc5 = Math.random() * com.clubpenguin.world.rooms.weathereffects.effect.FireEffectGenerator._delayTime;
        var _loc4 = new Array();
        _loc4.push(_loc2);
        _loc4.push(this);
        com.clubpenguin.world.rooms.weathereffects.effect.FireEffectGenerator._tweenObjects[index] = new com.greensock.TweenMax(_loc2, 0, {delay: _loc5, onComplete: beginEffect, onCompleteParams: _loc4});
