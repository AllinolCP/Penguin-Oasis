class com.greensock.OverwriteManager
{
    ...
    static function manageOverwrites(tween, props, targetTweens, mode)
    {
        ...
        var _loc7 = tween.cachedStartTime + 0;
        var _loc9 = [];
        var _loc13 = [];
        var _loc15 = 0;
        var _loc12 = 0;
        ...
        {
            _loc1 = targetTweens[_loc3];
            if (_loc1 == tween || _loc1.gc || !_loc1.initted && _loc7 - _loc1.cachedStartTime <= 0)
            {
                continue;
            } // end if
            ...
            if (_loc1.cachedStartTime <= _loc7 && _loc1.cachedStartTime + _loc1.__get__totalDuration() + 0 > _loc7 && !_loc1.cachedPaused && !(tween.cachedDuration == 0 && _loc7 - _loc1.cachedStartTime <= 0))
            {
                _loc9[_loc12++] = _loc1;
            } // end if
        } // end while
        if (_loc15 != 0)
        {
            var _loc4 = tween.cachedTimeScale;
            var _loc5 = _loc7;
            var _loc6;
            var _loc11;
            var _loc2;
            ...
            {
                _loc4 = _loc4 * _loc2.cachedTimeScale;
                _loc5 = _loc5 + _loc2.cachedStartTime;
            } // end of for
            _loc7 = _loc4 * _loc5;
            _loc3 = _loc15;
            while (--_loc3 > -1)
            {
                _loc6 = _loc13[_loc3];
                _loc4 = _loc6.cachedTimeScale;
                _loc5 = _loc6.cachedStartTime;
                for (var _loc2 = _loc6.timeline; _loc2; _loc2 = _loc2.timeline)
                {
                    _loc4 = _loc4 * _loc2.cachedTimeScale;
                    _loc5 = _loc5 + _loc2.cachedStartTime;
                } // end of for
                _loc11 = _loc4 * _loc5;
                if (_loc11 <= _loc7 && (_loc11 + _loc6.__get__totalDuration() * _loc4 + 0 > _loc7 || _loc6.cachedDuration == 0))
                {
                    _loc9[_loc12++] = _loc6;
                } // end if
            } // end while
