class com.greensock.plugins.TintPlugin extends com.greensock.plugins.TweenPlugin
{
    ...
    function init(target, end)
    {
        ...
        var _loc2 = _color.getTransform();
        var _loc6;
        var _loc4;
        for (var _loc4 in end)
        {
            if (_loc2[_loc4] != end[_loc4])
            {
                _tweens[_tweens.length] = new com.greensock.core.PropTween(_loc2, _loc4, _loc2[_loc4], end[_loc4] - _loc2[_loc4], "tint", false);
            } // end if
        } // end of for...in
    } // End of the function
