class com.greensock.plugins.TweenPlugin
{
    ...
    static function onTweenEvent(type, tween)
    {
        ...
        if (type == "onInitAllProps")
        {
            ...
            _loc2.sortOn("priority", Array.NUMERIC | Array.DESCENDING);
            while (--_loc3 > -1)
            {
                _loc2[_loc3].nextNode = _loc2[_loc3 + 1];
                _loc2[_loc3].prevNode = _loc2[_loc3 - 1];
            } // end while
        } // end if
        for (var _loc1 = tween.cachedPT1 = _loc2[0]; _loc1; _loc1 = _loc1.nextNode)
        {
