class com.greensock.TweenMax extends com.greensock.TweenLite
{
    ...
    function updateTo(vars, resetDuration)
    {
        ...
        if (initted)
        {
            ...
            else
            {
                ...
                {
                    var _loc7 = cachedTime;
                    this.renderTime(0, true, false);
                    initted = false;
                    this.renderTime(_loc7, true, false);
                }
    ...
    function renderTime(time, suppressEvents, force)
    {
        ...
        if (_repeat != 0)
        {
            var _loc5 = cachedDuration + _repeatDelay;
            var _loc11 = _cyclesComplete;
            _cyclesComplete = cachedTotalTime / _loc5 >> 0;
            if (_cyclesComplete == cachedTotalTime / _loc5)
            {
                --_cyclesComplete;
            } // end if
            if (_loc11 != _cyclesComplete)
            {
                _loc12 = true;
            } // end if
            if (_loc4)
            ...
            {
                cachedTime = (cachedTotalTime / _loc5 - _cyclesComplete) * _loc5;
        ...
        if (_loc6 == cachedTotalTime && !force)
        {
            return;
        }
        else if (!initted)
        ...
        if (_loc6 == 0 && vars.onStart && (cachedTotalTime != 0 || cachedDuration == 0) && !suppressEvents)
        {
    ...
    static function allTo(targets, duration, vars, stagger, onCompleteAll, onCompleteAllParams, onCompleteAllScope)
    {
        ...
        var _loc6 = targets.length;
        var _loc7 = [];
        var _loc4 = vars.delay || 0;
        ...
        {
            _loc2 = {};
            for (var _loc5 in vars)
            {
                _loc2[_loc5] = vars[_loc5];
            } // end of for...in
            _loc2.delay = _loc4;
            if (_loc1 == _loc8 && onCompleteAll != undefined)
            {
                _loc2.onComplete = function ()
                {
            ...
            _loc7[_loc1] = new com.greensock.TweenMax(targets[_loc1], duration, _loc2);
            _loc4 = _loc4 + stagger;
        } // end of for
        return (_loc7);
    } // End of the function
    ...
    {
        var _loc4 = com.greensock.TweenLite.masterList;
        var _loc5 = 0;
        var _loc3 = [];
        var _loc2;
        var _loc1;
        ...
        {
            _loc2 = _loc4[_loc6].tweens;
            _loc1 = _loc2.length;
            while (--_loc1 > -1)
            {
                if (!_loc2[_loc1].gc)
                {
                    _loc3[_loc5++] = _loc2[_loc1];
                } // end if
            } // end while
        } // end of for...in
        return (_loc3);
