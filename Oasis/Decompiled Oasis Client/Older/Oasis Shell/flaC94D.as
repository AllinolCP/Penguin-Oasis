...
function e_noPlayTime(obj)
{
    ...
    var _loc2 = "<a href=\"" + getPath("community_web") + "\">";
    var _loc6 = "</a>";
...
function makePlayerObjectFromString(player_string)
{
    ...
    var _loc4 = String(_loc2[1]);
    var _loc6 = Number(_loc2[2]);
    var _loc5;
    if (isValidString(_loc4))
    {
        _loc5 = com.clubpenguin.util.Localization.getLocalizedNickname(_loc3, _loc4, _loc6, getLanguageBitmask());
    }
    else if (isPlayerMascotById(_loc3))
    {
        _loc5 = getMascotNicknameByID(_loc3);
    } // end else if
    var _loc1 = new Object();
    _loc1.nickname = _loc5;
    _loc1.username = _loc4;
...
function setMyPlayerTotalCredits(amount)
{
    if (!isNaN(amount))
    {
        my_player.credits = amount;
        var _loc1 = new Object();
        _loc1.credits = my_player.credits;
...
{
    showLoading(getLocalizedString("Loading Snowball Info"));
    "gmsi";
    [];
    "str";
    AIRTOWER.send(AIRTOWER.GAME_EXT, getCurrentServerRoomId());
} // End of the function
...
{
    var _loc2 = "remove";
    if (_global.getCurrentShell().OasisPermission.hasPermission("a", getPlayerObjectById().account_permissions, action) == false)
    {
        _loc2 = "add";
    } // end if
    AIRTOWER.send(AIRTOWER.PLAY_EXT, AIRTOWER.MODERATION_HANDLER + "#alter_perm", [playerID, action, _loc2], "str", getCurrentServerRoomId());
} // End of the function
...
function InitAllConfigs()
{
    ...
    for (var _loc3 in _loc2.tuning.shell)
    {
        _global.getCurrentShell()[_loc3] = _loc2.tuning.shell[_loc3];
    } // end of for...in
    false;
    for (var _loc4 in _loc2.tuning.rooms)
    {
        room_crumbs[Number(_loc4)] = _loc2.tuning.rooms[Number(_loc4)];
    } // end of for...in
} // End of the function
...
{
    obj.shift();
    var _loc1 = obj.shift(); //PlayerId
    if (isNaN(_loc1))
    {
        return (false);
    } // end if
    var _loc3 = obj.shift(); //NameGlow
    var _loc2 = obj.shift(); //NameColor
...
function handleRealTimeTransform(obj)
{
    ...
    if (_loc4 < 1 || isNaN(_loc4))
    {
        return;
    } // end if
    var _loc6 = INTERFACE.getPlayerObject(_loc3);
    _loc6.data[20] = _loc4;
    var _loc9 = ENGINE.getPlayerMovieClip(_loc3);
    var _loc7 = com.clubpenguin.util.URLUtils.getCacheResetURL(_global._oasis.$httpType + _global.GetConfiguration().client.media.directories.cdn_base + "/play/v2/content/global/penguin/" + _loc4 + ".swf");
    var _loc5 = new com.clubpenguin.hybrid.HybridMovieClipLoader();
    _loc5.addEventListener(com.clubpenguin.hybrid.HybridMovieClipLoader.EVENT_ON_LOAD_INIT, com.clubpenguin.util.Delegate.create(this, ENGINE.onPlayerLoadInit, _loc6, _loc3, INTERFACE.nicknames_mc["p" + _loc3]._x, INTERFACE.nicknames_mc["p" + _loc3]._y));
    _loc5.addEventListener(com.clubpenguin.hybrid.HybridMovieClipLoader.EVENT_ON_LOAD_START, com.clubpenguin.util.Delegate.create(this, ENGINE.onPlayerLoadStart, target_mc));
    _loc5.addEventListener(com.clubpenguin.hybrid.HybridMovieClipLoader.EVENT_ON_LOAD_PROGRESS, com.clubpenguin.util.Delegate.create(this, ENGINE.onPlayerLoadProgress, target_mc));
    _loc5.loadClip(_loc7, _loc9.art_mc);
} // End of the function
...
function handleReceivedCredits(obj)
{
    ...
    setMyPlayerTotalCredits(getMyPlayerTotalCredits() + Number(_loc1));
} // End of the function
function handleGetMySnowballInfo(result)
{
    result.shift();
    snowballInfo.player_id = Number(result.shift());
...
function quietAirtower()
{
    ...
    AIRTOWER.removeListener("rtpt", handleRealTimeTransform);
...
function enableAirtower()
{
    ...
    AIRTOWER.addListener("rtpt", handleRealTimeTransform);
