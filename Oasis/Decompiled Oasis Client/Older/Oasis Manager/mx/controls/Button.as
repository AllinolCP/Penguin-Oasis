class mx.controls.Button extends mx.controls.SimpleButton
{
    ...
    function setView(offset)
    {
        ...
        var _loc9 = __width - borderW - borderW;
        var _loc10 = __height - borderW - borderW;
        if (_loc2 != undefined)
        {
            _loc7 = _loc2._width;
            _loc6 = _loc2._height;
        ...
        if (_loc12 == "left" || _loc12 == "right")
        {
            if (_loc3 != undefined)
            {
                _loc11 = Math.min(_loc9 - _loc7, _loc15 + 5);
                _loc3._width = Math.min(_loc9 - _loc7, _loc15 + 5);
                _loc8 = Math.min(_loc10, _loc14 + 5);
                _loc3._height = Math.min(_loc10, _loc14 + 5);
            } // end if
            if (_loc12 == "right")
            {
                _loc5 = _loc7;
                if (centerContent)
                {
                    _loc5 = _loc5 + (_loc9 - _loc11 - _loc7) / 2;
                } // end if
                _loc2._x = _loc5 - _loc7;
            }
            else
            {
                _loc5 = _loc9 - _loc11 - _loc7;
                if (centerContent)
                {
                    _loc5 = _loc5 / 2;
                } // end if
                _loc2._x = _loc5 + _loc11;
            } // end else if
            _loc4 = 0;
            _loc2._y = 0;
            if (centerContent)
            {
                _loc2._y = (_loc10 - _loc6) / 2;
                _loc4 = (_loc10 - _loc8) / 2;
            } // end if
            if (!centerContent)
            {
        ...
        else
        {
            if (_loc3 != undefined)
            {
                _loc11 = Math.min(_loc9, _loc15 + 5);
                _loc3._width = Math.min(_loc9, _loc15 + 5);
                _loc8 = Math.min(_loc10 - _loc6, _loc14 + 5);
                _loc3._height = Math.min(_loc10 - _loc6, _loc14 + 5);
            } // end if
            _loc5 = (_loc9 - _loc11) / 2;
            _loc2._x = (_loc9 - _loc7) / 2;
            if (_loc12 == "top")
            {
                _loc4 = _loc10 - _loc8 - _loc6;
                if (centerContent)
                {
                    _loc4 = _loc4 / 2;
                } // end if
            ...
            else
            {
                ...
                if (centerContent)
                {
                    _loc4 = _loc4 + (_loc10 - _loc8 - _loc6) / 2;
                } // end if
