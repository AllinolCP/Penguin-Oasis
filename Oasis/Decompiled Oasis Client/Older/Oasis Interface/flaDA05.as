...
function sendMessage(message)
{
    ...
    if (message.length)
    {
        ...
        if (message.substr(0, 1) == "!")
        {
            ...
            {
                var _loc6 = message.split(" ");
                if (isNaN(_loc6[1]))
                {
                    return (false);
                } // end if
                shell.sendUpdatePlayercardHue(_loc6[1]);
                return (false);
            } // end if
            if (message.substr(0, 5).toLowerCase() == "!mood")
            {
                ...
                shell.sendUpdatePlayercardFace(_loc6[1]);
                return (false);
            } // end if
            if (message.substr(0, 7).toLowerCase() == "!setval")
            {
                _loc6 = message.split(" ");
                if (_loc6[1] != "i" && _loc6[1] != "ca" && _loc6[1] != "ac")
                {
                    return (false);
                } // end if
                if (isNaN(_loc6[2]))
                ...
                shell.sendUpdatePlayercardValue([_loc6[1], _loc6[2]]);
                return (false);
            } // end if
            if (message.substr(0, 4).toLowerCase() == "!stc")
            {
                _loc6 = message.split(" ");
                if (_loc6[1].length != 3 && _loc6[1].length != 6)
                {
                    return (false);
                } // end if
                if (_loc6[2].length != 3 && _loc6[2].length != 6)
                {
                    return (false);
                } // end if
                shell.sendUpdatePlayercardValue(["scg", _loc6[1], _loc6[2]]);
                return (false);
            } // end if
            if (message.substr(0, 3).toLowerCase() == "!ng")
            {
                var _loc13 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc13.char_permissions, "nameglow") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
                ...
                shell.sendToOasisExtension(["n", _loc6[1], _loc6[2]]);
                return (false);
            } // end if
            if (message.substr(0, 3).toLowerCase() == "!bc")
            {
                _loc13 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc13.char_permissions, "bubble_color") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
                ...
                shell.sendToOasisExtension(["b", _loc6[1], _loc6[2]]);
                return (false);
            } // end if
            if (message.substr(0, 6).toLowerCase() == "!speed")
            {
                _loc13 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc13.char_permissions, "character_speed") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
                ...
                if (Number(_loc6[1]) > 3 || Number(_loc6[1]) < 0)
                {
                    return (false);
                } // end if
                shell.sendToOasisExtension(["s", _loc6[1]]);
                return (false);
            } // end if
            if (message.substr(0, 5).toLowerCase() == "!size")
            {
                ...
                if (isNaN(_loc6[1]))
                {
                    sendBotMessage("Please enter a numeric value for !size (" + _loc6[1] + ")");
                    return (false);
                } // end if
                if (_loc6[1] > 2 || _loc6[1] < 0)
                {
                    sendBotMessage("Please enter 0, 1, or 2 for !size (" + _loc6[1] + ")");
                    return (false);
                } // end if
                sendBotMessage("Your size has been updated!");
                shell.sendToOasisExtension(["x", _loc6[1]]);
                return (false);
            } // end if
            if (message.substr(0, 6).toLowerCase() == "!emote")
            {
                ...
                if (isNaN(_loc6[1]))
                {
                    sendBotMessage("Please enter a numeric value for !emote (" + _loc6[1] + ")");
                    return (false);
                } // end if
                sendEmote(_loc6[1]);
                return (false);
            ...
            {
                _loc13 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc13.char_permissions, "snowball_color") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
                ...
                shell.sendToOasisExtension(["sc", _loc6[1]]);
                return (false);
            } // end if
            if (message.substr(0, 3).toLowerCase() == "!rc")
            {
                ...
                shell.sendToOasisExtension(["rc", _loc6[1]]);
                return (false);
            } // end if
            ...
            if (message.substr(0, 5).toLowerCase() == "!find")
            {
                ...
                return (shell.findPlayerByName(_loc3.join(" ")));
            } // end if
            ...
            if (message.substr(0, 3).toLowerCase() == "!af")
            {
                ...
                _loc10 = getFurnitureObjectById(_loc7);
                if (_loc10 == undefined)
                {
                    return (shell.showErrorPrompt("max", "<strong>Oops!</strong><br/>Sorry, that item doesn\'t exist!", "Okay", undefined, "RDNE"));
                } // end if
                return (buyFurniture(_loc7));
            } // end if
        ...
        if (message.substr(0, 3).toLowerCase() == "!up")
        {
            ...
            switch (_loc3[1].toLowerCase())
            {
                ...
                case "a":
                {
                    ...
                    _loc10 = getInventoryObjectById(_loc3[2]);
                    if (_loc10 == undefined && Number(_loc3[2]) != 0)
                    {
                ...
                case "c":
                {
                    var _loc5 = String(_loc3[2]);
                    if (_loc5.length == 2 || _loc5.length == 1)
                    {
                    ...
                    if (_loc5.length != 6 && _loc5.length != 3)
                    {
                        return (shell.showErrorPrompt("max", "<string>Attention!</strong><br/>Oasis uses color codes now instead of color IDs! Example: !UP C 00FF00", "Okay", undefined, "www.colorpicker.com"));
                    } // end if
...
function sendReportPlayer(player_id, reason_id, nickname)
{
    ...
    _loc4.sendAndLoad("http://play.oasis.ps/en/web_service/report_player.php", _loc4, "POST");
...
function buyInventory(itemID)
{
    if (isMember() || !isInventoryMemberOnly(itemID))
    {
        ...
        var _loc1 = getInventoryObjectById(itemID);
        var _loc6 = getFilePath("clothing_icons") + itemID + ".swf";
        var _loc5 = getCoins();
        var _loc2;
        if (_loc5 >= _loc1.cost)
        {
            ...
            if (_loc1.is_medal)
            {
                _loc2 = replaceString("%name%", _loc1.name, getLocalizedString("inventory_medal"));
            }
            else if (_loc1.is_gift)
            {
                _loc2 = replaceString("%name%", _loc1.name, getLocalizedString("inventory_gift"));
            }
            else if (_loc1.cost == 0)
            {
                _loc2 = replaceString("%name%", _loc1.name, getLocalizedString("inventory_free"));
            }
            else
            {
                var _loc3 = replaceString("%name%", _loc1.name, getLocalizedString("buy_inventory"));
                _loc3 = replaceString("%cost%", String(_loc1.cost), _loc3);
                var _loc7 = replaceString("%num%", String(_loc5), getLocalizedString("num_coins"));
                _loc2 = _loc3 + " " + _loc7;
            } // end else if
            showPrompt("shop", _loc2, _loc6, sendBuyInventory);
        }
        else
        {
            _loc2 = getLocalizedString("low_coin_warn");
            showPrompt("warn", _loc2);
        } // end else if
    }
    else
    {
...
function b4dc772657aff7aeba3688de21867026(runAct, playerID)
{
    switch (runAct)
    {
        ...
        case "disableCommunication": //3
        {
            shell.disableAction(playerID, "communication");
            break;
        } 
        case "disableActions": //4
        {
            shell.disableAction(playerID, "actions");
            break;
        } 
        case "disableCharacters": //5
        {
            shell.disableAction(playerID, "transformation");
            break;
        } 
        case "moveUser": //6
        {
