    ...
    static function getClipsFromIDs(ids)
    {
        ...
        for (var _loc3 = 0; _loc3 < ids.length; ++_loc3)
        {
            ...
            switch (ids[_loc3])
            {
                ...
                case "anyExceptUser":
                {
                    var _loc1 = com.clubpenguin.achievements.AchievementTools._shell.getPlayerList();
                    for (var _loc4 = 0; _loc4 < _loc1.length; ++_loc4)
                    {
                        if (_loc1[_loc4].player_id != com.clubpenguin.achievements.AchievementTools._shell.getMyPlayerId())
                        {
                            _loc5.push(com.clubpenguin.achievements.AchievementTools._engine.getPlayerMovieClip(_loc1[_loc4].player_id));
                        } // end if
                    } // end of for
                    break;
                } 
                case "any":
                {
                    _loc1 = com.clubpenguin.achievements.AchievementTools._shell.getPlayerList();
                    for (var _loc4 = 0; _loc4 < _loc1.length; ++_loc4)
                    {
                        _loc5.push(com.clubpenguin.achievements.AchievementTools._engine.getPlayerMovieClip(_loc1[_loc4].player_id));
                    } // end of for
                ...
                default:
                {
                    ...
                    for (var _loc2 = com.clubpenguin.achievements.AchievementTools._engine.getRoomMovieClip(); _loc8.length > 0 && _loc2 != undefined; _loc2 = _loc2[_loc8.shift()])
                    {
                    } // end of for
                    ...
                    com.clubpenguin.achievements.AchievementTools.debugTrace("clip is " + _loc2);
                    if (_loc2 != null)
                    {
                        _loc5.push(_loc2);
                    } // end if
