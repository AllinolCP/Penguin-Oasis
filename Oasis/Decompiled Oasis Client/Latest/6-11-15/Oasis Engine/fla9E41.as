...
function teleportPlayer(player_id, x, y, isTrigger, frame)
{
    ...
    if (_loc2.is_moving)
    {
        ...
        updatePlayerFrame(player_id, frame != undefined ? (frame) : (_loc2.lastMoveDirection));
        if (SHELL.isMyPlayer(player_id))
        {
...
function attachShellListeners()
{
    ...
    SHELL.addListener(SHELL.TELEPORT_PLAYER, handlePlayerTeleport);
