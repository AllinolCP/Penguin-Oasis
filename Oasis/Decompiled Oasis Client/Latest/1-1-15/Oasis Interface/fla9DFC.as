...
function sendMessage(message)
{
    ...
    if (message.length)
    {
        ...
        if (message.substr(0, 1) == "!")
        {
            ...
            {
                var _loc19 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc19.char_permissions, "nameglow") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
            ...
            {
                _loc19 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc19.char_permissions, "bubble_color") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
            ...
            {
                _loc19 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc19.char_permissions, "character_speed") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
            ...
            {
                _loc19 = SHELL.getMyPlayerObject();
                if (_global.getCurrentShell().OasisPermission.hasPermission("char", _loc19.char_permissions, "snowball_color") == false)
                {
                    return (false);
                } // end if
                _loc6 = message.split(" ");
            ...
            if (message.substr(0, 3).toLowerCase() == "!jr")
            {
                ...
                if (isNaN(_loc7))
                {
                    var _loc16 = getRoomCrumbsByName(_loc7);
                    if (_loc16 == undefined)
                    {
                        return (shell.showErrorPrompt("max", "<strong>Oops!</strong><br/>Sorry, that room doesn\'t exist!", "Okay", undefined, "RDNE"));
                    } // end if
                    return (sendJoinRoom(_loc7, 0, 0));
                } // end if
                var _loc12 = shell.getRoomCrumbsById(_loc7);
                if (_loc12 == undefined)
                {
                    return (shell.showErrorPrompt("max", "<strong>Oops!</strong><br/>Sorry, that room doesn\'t exist!", "Okay", undefined, "RDNE"));
                } // end if
