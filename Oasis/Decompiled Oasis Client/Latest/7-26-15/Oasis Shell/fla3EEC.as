...
function e_default(obj)
{
    ...
    var _loc4 = getLocalizedErrorStringById(DEFAULT_ERROR);
...
{
    $d("[" + obj.type + "] e_itemNotAvailable() -> Item is not available");
    var _loc3 = window_size[WINDOW_SMALL];
    var _loc5 = getLocalizedErrorStringById(410);
    var _loc2 = getLocalizedString("Okay");
    var _loc1 = "e410";
    var _loc4 = function ()
    {
...
function e_noDatabaseConnection(obj)
{
    ...
    var _loc3 = window_size[WINDOW_SMALL];
    var _loc5 = "There was an error getting the database transaction.";
    var _loc2 = getLocalizedString("Okay");
...
function showLoadingProgress(message, bytesLoaded, bytesTotal)
{
    ...
    if (message)
    {
        ...
        flash.external.ExternalInterface.call("Oasis.Main.ShowLoadText", loading.message_txt.text);
    }
    else
    {
...
function setRoomCrumbs(obj)
{
    ...
    for (var _loc1 in obj)
    {
        obj[_loc1].origPath = obj[_loc1].path;
...
{
    var _loc2 = player_string.split("|");
    var _loc5 = Number(_loc2[0]);
    var _loc7 = String(_loc2[1]);
    ...
    _loc1.colour_id = String(_loc2[3]) || 0;
    _loc1.head = Number(_loc2[4]) || 0;
    _loc1.face = Number(_loc2[5]) || 0;
    _loc1.neck = Number(_loc2[6]) || 0;
    _loc1.body = Number(_loc2[7]) || 0;
    _loc1.hand = Number(_loc2[8]) || 0;
    _loc1.feet = Number(_loc2[9]) || 0;
    _loc1.flag_id = Number(_loc2[10]) || 0;
    _loc1.photo_id = Number(_loc2[11]) || 0;
    var _loc4 = ["head", "face", "neck", "body", "hand", "feet"];
    for (var _loc6 in _loc4)
    {
        var _loc3 = Number(_loc1[_loc4[_loc6]]);
        if (_loc3 == 0)
        {
            continue;
        } // end if
        if (banned_items[_loc3] != undefined)
        {
            _loc1[_loc4[_loc6]] = 0;
        } // end if
        if (banned_items[String(_loc3)] != undefined)
        {
            _loc1[_loc4[_loc6]] = 0;
        } // end if
    } // end of for...in
    _loc1.x = Number(_loc2[12]) || 0;
    _loc1.y = Number(_loc2[13]) || 0;
    _loc1.frame = Number(_loc2[14]) || 0;
    _loc1.is_member = Boolean(Number(_loc2[15]) || 0);
    _loc1.total_membership_days = Number(_loc2[16]) || 0;
    if (!isSnowball)
    {
        _loc1.playercard_attributes = parseJson(_loc2[19]);
        _loc1.account_permissions = _loc2[20];
        _loc1.char_permissions = _loc2[21];
        _loc1.player_attributes = parseJson(_loc2[22]);
        _loc1.ia = Boolean(Number(_loc2[23]));
        _loc1.credits = Number(_loc2[24]);
        _loc1.characterId = String(_loc2[25]);
        _loc1.is_involved_in_event = Boolean(Number(_loc2[26]));
        _loc1.has_special_event_permission = Boolean(Number(_loc2[27]));
    }
    else
    {
        _loc1.size_decrease = Number(_loc2[19]);
        _loc1.alpha = Number(_loc2[20]);
    } // end else if
...
{
    if (id > 70000 && isForAdd != true)
    {
        var _loc1 = new Object();
        _loc1.name = "Custom Background";
        _loc1.id = id;
        _loc1.type = 8;
        _loc1.cost = 0;
        _loc1.is_member = true;
        return (_loc1);
    } // end if
...
function startNpcScene(player_id)
{
    AIRTOWER.send(AIRTOWER.PLAY_EXT, AIRTOWER.MODERATION_HANDLER + "#npc_kick", [player_id, 807], "str", getCurrentServerRoomId());
} // End of the function
...
function addWorld(world_id, world_name, world_ip, world_port, is_safe, world_type)
{
...
function addWorldLogin(world_id, world_pop, world_buddies)
{
    var _loc1 = getWorldById(world_id);
    _loc1.onlineUsers = world_pop;
    _loc1.onlineBuds = world_buddies;
    return ("A: " + world_id);
} // End of the function
function setRoomPath(room_key, local_path)
{
    if (isSnowball)
    {
        return;
    ...
    for (var _loc3 in _loc1)
    {
        if (_loc3 == room_key)
        {
            _loc1[_loc3].path = "http://cdn.oasis.ps/play/v2/content/global/rooms/" + local_path;
            if (getCurrentRoomId() == _loc1[_loc3].room_id)
            {
                ENGINE.reloadRoom(_loc1[_loc3]);
            } // end if
            return (true);
        } // end if
    } // end of for...in
} // End of the function
function setDefaultRooms()
{
    var _loc1 = getRoomCrumbs();
    for (var _loc2 in _loc1)
    {
        _loc1[_loc2].path = getGlobalContentPath() + "rooms/" + _loc1[_loc2].origPath;
    } // end of for...in
} // End of the function
...
function onLoginDependencyLoaderComplete()
{
    ...
    LOGIN_HOLDER.viewManager.gotoNewPlayer();
    flash.external.ExternalInterface.call("Oasis.Login.AllowLogin");
} // End of the function
...
function sendLogin(username, pass, on_response)
{
    ...
    login_response = on_response;
    flash.external.ExternalInterface.call("Oasis.Login.SubmitLoginFromFlash", username, pass);
    hideLoading();
} // End of the function
function handleExternalLogin(userObj)
{
    if (userObj.login_str == undefined || userObj.confirm_key == undefined)
    {
        return (false);
    } // end if
    ...
    var _loc2 = [undefined, userObj.player_id, userObj.login_key, "", "", "", "", "", userObj.username, userObj.login_str, userObj.confirm_key];
    AIRTOWER.handleOnLogin(_loc2);
    LOGIN_HOLDER.gotoWorldSelection();
    ...
    (com.clubpenguin.login.views.ViewManager)(LOGIN_HOLDER.viewManager).gotoWorldSelection();
} // End of the function
...
function handleStartRadio(obj)
{
    obj.shift();
    var _loc1 = obj.shift();
    flash.external.ExternalInterface.call("startRadio", _loc1);
} // End of the function
function handleStopRadio(obj)
{
    obj.shift();
    flash.external.ExternalInterface.call("stopRadio");
} // End of the function
...
function handleCreateNPCScene(obj)
{
    var _loc3 = obj.shift();
    var _loc1 = Number(obj[0]);
...
{
    var _loc7 = obj.shift();
    var _loc6 = Number(obj[0]);
    var _loc4 = Number(obj[1]);
    var _loc5 = Number(obj[2]);
    var _loc2 = playerIndexInRoom(_loc6);
    ...
    if (penguin_index != -1)
    {
        ...
        _loc1.x = _loc4;
        _loc1.y = _loc5;
        updateListeners(PLAYER_TELEPORT, _loc1);
    }
    else
    {
        $d("[shell] Trying to move a penguin who was not found in the room. player_id: " + _loc1);
    } // end else if
} // End of the function
...
function handleTvMessage(obj)
{
    _global.getCurrentEngine().getRoomMovieClip().tv_mc.tv_txt.stage_txt.text = obj.shift();
} // End of the function
function handleUpdateEventOn(obj)
{
    _global._configuration.tuning.is_event_major_active = true;
    if (getCurrentRoomId() == 810)
    {
        _global.getCurrentEngine().getRoomMovieClip().confShow.gotoAndStop(1);
        _global.getCurrentEngine().getRoomMovieClip().confShow2.gotoAndStop(1);
        _global.getCurrentEngine().getRoomMovieClip().confShow.gotoAndStop(2);
        _global.getCurrentEngine().getRoomMovieClip().confShow2.gotoAndStop(2);
        _global.getCurrentEngine().getRoomMovieClip().block_off._visible = false;
    } // end if
} // End of the function
...
function handleRealTimeNameglow(obj)
{
    ...
    if (INTERFACE.nicknames_mc["p" + _loc2] == undefined)
    {
        return (false);
    } // end if
    if (String(_loc3) == "0" || _loc3 == "")
    {
        INTERFACE.nicknames_mc["p" + _loc2].name_txt.textColor = 0;
    }
    else
    {
        INTERFACE.nicknames_mc["p" + _loc2].name_txt.textColor = "0x" + _loc3;
    } // end else if
    if (String(_loc1) == "0" || _loc1 == "")
    {
        INTERFACE.nicknames_mc["p" + _loc2].name_txt.filters = undefined;
    }
    else
    {
        _loc1 = "0x" + _loc1;
        var _loc5 = new flash.filters.GlowFilter(_loc1, 10, 1.700000, 1.700000, 15, 3, false, false);
        INTERFACE.nicknames_mc["p" + _loc2].name_txt.filters = [_loc5];
    } // end else if
} // End of the function
...
function handleHasSpecialPerm(obj)
{
    obj.shift();
    var _loc1 = obj.shift();
    if (isNaN(_loc1))
    ...
    var _loc2 = ENGINE.getPlayerMovieClip(_loc1);
    _loc2.has_special_event_permission = true;
} // End of the function
...
function quietAirtower()
{
    ...
    AIRTOWER.removeListener("rpn", handleCreateNPCScene);
    AIRTOWER.removeListener("sradio", handleStartRadio);
    AIRTOWER.removeListener("stradio", handleStopRadio);
    AIRTOWER.removeListener("evon", handleUpdateEventOn);
    AIRTOWER.removeListener("special", handleHasSpecialPerm);
    AIRTOWER.removeListener("tv", handleTvMessage);
...
function enableAirtower()
{
    ...
    AIRTOWER.addListener("rpn", handleCreateNPCScene);
    AIRTOWER.addListener("sradio", handleStartRadio);
    AIRTOWER.addListener("stradio", handleStopRadio);
    AIRTOWER.addListener("evon", handleUpdateEventOn);
    AIRTOWER.addListener("special", handleHasSpecialPerm);
    AIRTOWER.addListener("tv", handleTvMessage);
...
flash.external.ExternalInterface.addCallback("handleExternalLogin", null, handleExternalLogin);
var REL = new Object();
System.security.allowDomain("*");
flash.external.ExternalInterface.addCallback("setWorldForConnection", null, setWorldForConnection);
flash.external.ExternalInterface.addCallback("addWorld", null, addWorld);
flash.external.ExternalInterface.addCallback("addWorldLogin", null, addWorldLogin);
var isSnowball = false;
flash.external.ExternalInterface.addCallback("setRoomPath", null, setRoomPath);
flash.external.ExternalInterface.addCallback("setDefaultRooms", null, setDefaultRooms);
var current_bot_str;
var disabledArea = [];
...
var PLAYER_TELEPORT = "teleportPlayer";
var TELEPORT_PLAYER = "teleportPlayer";
