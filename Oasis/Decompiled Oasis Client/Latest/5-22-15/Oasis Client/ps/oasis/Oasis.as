class ps.oasis.Oasis
{
    function Oasis()
    {
        ...
        _loc4.load($httpType + "://service-authx1.oasis.ps/configuration/latest");
    } // End of the function
    function LoadLatestTuning()
    {
        ...
        _loc3.load($httpType + "://service-authx1.oasis.ps/configuration/tuning/" + _global._configuration.latest_tuning);
    } // End of the function
