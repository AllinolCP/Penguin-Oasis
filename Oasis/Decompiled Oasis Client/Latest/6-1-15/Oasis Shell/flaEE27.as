...
function handleUpdateEventOn(obj)
{
    ...
    if (getCurrentRoomId() == 807)
    {
        _global.getCurrentEngine().getRoomMovieClip().prom_building.signs_mc.marquee_mc.gotoAndStop(2);
        _global.getCurrentEngine().getRoomMovieClip().prom_building.stageEntrance_mc.gotoAndStop(2);
        ...
        _global.getCurrentEngine().getRoomMovieClip().interface_mc.vote_btn._visible = true;
        _global.getCurrentEngine().getRoomMovieClip().interface_mc.vote_btn.onRelease = function ()
        {
            _global.getCurrentInterface().showContent("Voting", undefined, _global._oasis.$httpType + _global.GetConfiguration().client.media.directories.cdn_base + "/play/v2/content/global/content/vote.swf");
        };
    } // end if
} // End of the function
