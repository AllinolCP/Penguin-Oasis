class com.clubpenguin.engine.avatar.effect.AvatarEffectEnum
{
    ...
    static var JANUARY_BATTLE_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.LIB_AVATAR_NAME, "iconBattle", com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_ATTACH_TO_PLAYER | com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_STOP_ON_LAST_FRAME);
    static var JANUARY_BATTLE_POINTS_WIN = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.LIB_AVATAR_NAME, "battlePointsWin", com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_NONE);
    static var JANUARY_BATTLE_POINTS_LOSS = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.LIB_AVATAR_NAME, "battlePointsLoss", com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_NONE);
    static var JANUARY_BATTLE_LOW_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.LIB_AVATAR_NAME, "battleLowIcon", com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_ATTACH_TO_PLAYER | com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_STOP_ON_LAST_FRAME);
    static var JANUARY_BATTLE_MID_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.LIB_AVATAR_NAME, "battleMidIcon", com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_ATTACH_TO_PLAYER | com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_STOP_ON_LAST_FRAME);
    static var JANUARY_BATTLE_HIGH_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.LIB_AVATAR_NAME, "battleHighIcon", com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_ATTACH_TO_PLAYER | com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.FLAG_STOP_ON_LAST_FRAME);
