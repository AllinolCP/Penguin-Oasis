class com.clubpenguin.world.rooms.common.triggers.TriggerWatcher
{
    ...
    function addTrigger(triggerToAdd)
    {
        ...
        var _loc8 = Math.floor(Math.floor(_loc10.xMin) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        var _loc6 = Math.floor(Math.floor(_loc10.yMin) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        var _loc9 = Math.floor(Math.floor(_loc10.xMax) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        var _loc7 = Math.floor(Math.floor(_loc10.yMax) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
    ...
    function checkTriggers(object)
    {
        ...
        var _loc3 = Math.floor(_loc2._x / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        var _loc4 = Math.floor(_loc2._y / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        if (_targetGrid[_loc3][_loc4])
        {
            _targetGrid[_loc3][_loc4].hitTest(object, _loc2);
        } // end if
    } // End of the function
    function toString()
    {
