...
{
    var vars, cachedTotalDuration, cachedDuration, _delay, cachedTimeScale, active, cachedTime, cachedTotalTime, data, cachedReversed, cachedPaused, cacheIsDirty, initted, gc, _rawPrevTime, __set__paused, __set__reversed, __get__totalDuration, timeline, cachedOrphan, cachedStartTime, cachedPauseTime, __get__startTime, __set__startTime, __get__delay, __get__duration, __set__duration, __get__currentTime, __get__totalTime, __get__reversed, __get__paused, __set__currentTime, __set__delay, __set__totalDuration, __set__totalTime;
    ...
    {
        this.__set__startTime(this.__get__startTime() + (n - _delay));
        _delay = n;
        null;
        //return (this.delay());
        null;
    ...
    {
        var _loc3 = n / cachedDuration;
        cachedDuration = cachedTotalDuration = n;
        if (active && !cachedPaused && n != 0)
        {
            this.setTotalTime(cachedTotalTime * _loc3, true);
        } // end if
        this.setDirtyCache(false);
        null;
