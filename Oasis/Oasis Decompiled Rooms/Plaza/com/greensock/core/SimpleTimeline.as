    ...
    function renderTime(time, suppressEvents, force)
    {
        ...
        while (_loc2)
        {
            ...
            if (_loc2.active || time >= _loc2.cachedStartTime && !_loc2.cachedPaused && !_loc2.gc)
            {
                ...
                {
                    _loc5 = _loc2.cacheIsDirty ? (_loc2.__get__totalDuration()) : (_loc2.cachedTotalDuration);
                    _loc2.renderTime(_loc5 - (time - _loc2.cachedStartTime) * _loc2.cachedTimeScale, suppressEvents, false);
                } // end if
            } // end else if
            _loc2 = _loc4;
        } // end while
