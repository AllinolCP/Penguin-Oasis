class com.greensock.TweenLite extends com.greensock.core.TweenCore
{
    ...
    function init()
    {
        ...
        {
            if (com.greensock.TweenLite._reservedProps[_loc6] && !(_loc6 == "timeScale" && target instanceof com.greensock.core.TweenCore))
            {
                continue;
            } // end if
            _loc2 = new com.greensock.TweenLite.plugins[_loc6]();
            if (com.greensock.TweenLite.plugins[_loc6] && new com.greensock.TweenLite.plugins[_loc6]().onInitTween(target, vars[_loc6], this))
            {
                cachedPT1 = new com.greensock.core.PropTween(_loc2, "changeFactor", 0, 1, _loc2.overwriteProps.length == 1 ? (_loc2.overwriteProps[0]) : ("_MULTIPLE_"), true, cachedPT1);
                if (cachedPT1.name == "_MULTIPLE_")
                {
                    _loc4 = _loc2.overwriteProps.length;
                    while (--_loc4 > -1)
                    {
                        propTweenLookup[_loc2.overwriteProps[_loc4]] = cachedPT1;
                    } // end while
                }
                else
                {
                ...
                if (_loc2.priority)
                {
                    cachedPT1.priority = _loc2.priority;
                    _loc5 = true;
                } // end if
                if (_loc2.onDisable || _loc2.onEnable)
                {
            ...
            cachedPT1 = new com.greensock.core.PropTween(target, _loc6, Number(target[_loc6]), typeof(vars[_loc6]) == "number" ? (Number(vars[_loc6]) - target[_loc6]) : (Number(vars[_loc6])), _loc6, false, cachedPT1);
            propTweenLookup[_loc6] = cachedPT1;
        } // end of for...in
        if (_loc5)
        {
        ...
        {
            for (var _loc3 = cachedPT1; _loc3; _loc3 = _loc3.nextNode)
            {
    ...
    function killVars(vars, permanent)
    {
        ...
        for (var _loc6 in vars)
        {
            if (propTweenLookup[_loc6])
            {
                _loc2 = propTweenLookup[_loc6];
                if (_loc2.isPlugin && _loc2.name == "_MULTIPLE_")
                {
                    ...
                    if (_loc6 != _loc2.target.propName || _loc2.name == "")
                    {
                        delete propTweenLookup[_loc6];
                    } // end if
                } // end if
    ...
    static function updateAll()
    {
        ...
        rootFrame = rootFrame = ++com.greensock.TweenLite.rootFrame;
    ...
    static function getID(target, lookup)
    {
        ...
        _cnt = _cnt = ++com.greensock.TweenLite._cnt;
    ...
    static function jumpStart(root)
    {
        ...
        _timingClip = _loc2.createEmptyMovieClip("__tweenLite" + String(com.greensock.core.TweenCore.version).split(".").join("_"), _loc1);
